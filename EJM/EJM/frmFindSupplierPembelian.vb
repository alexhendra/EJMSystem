Public Class frmFindSupplierPembelian
    ...
    Private Sub GetDataAll()
        Try
            Me.DaFindSupplierPembelian.Fill(Me.DsTrans.dtFindSupplierPembelian)
        Catch ex As Exception
            MessageBox.Show(ex.Message, "Menampilkan semua data", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try

        If DsTrans.dtFindSupplierPembelian.Rows.Count > 0 Then AddcboFind()
    End Sub
    ...
    Private Sub txtFind_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtFind.TextChanged
        With DtFindSupplierPembelianBindingSource
