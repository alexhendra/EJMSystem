Public Class frmFindPenerimaanBarang
    Dim con As New SqlConnection(My.Settings.EJMConString)
    Private _listResult As List(Of String)
    Private _kodePenerimaan As String = ""

    Public Sub New(ByVal kodePenerimaan As String)

        ' This call is required by the designer.
        InitializeComponent()

        _kodePenerimaan = kodePenerimaan
    End Sub
    ...
    Private Sub GetDataAll()
        Try
            Me.DaFindBarangPenerimaan.Fill(Me.DsTrans.dtFindBarangPenerimaan, _kodePenerimaan.Trim)
        Catch ex As Exception
            MessageBox.Show(ex.Message, "Menampilkan semua data", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try

        If DsTrans.dtFindBarangPenerimaan.Rows.Count > 0 Then AddcboFind()
    End Sub
    ...
    Private Sub txtFind_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtFind.TextChanged
        With DtFindBarangPenerimaanBindingSource
