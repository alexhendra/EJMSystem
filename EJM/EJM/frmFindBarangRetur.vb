Public Class frmFindBarangRetur
    Dim con As New SqlConnection(My.Settings.EJMConString)
    Private _listResult As List(Of String)
    Private _kodeRetur As String = ""

    Public Sub New(ByVal kodeRetur As String)

        ' This call is required by the designer.
        InitializeComponent()

        _kodeRetur = kodeRetur
    ...
    Private Sub GetDataAll()
        Try
            Me.DaFindBarangRetur.Fill(Me.DsTrans.dtFindBarangRetur, _kodeRetur)
        Catch ex As Exception
            MessageBox.Show(ex.Message, "Menampilkan semua data", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try

        If DsTrans.dtFindBarangRetur.Rows.Count > 0 Then AddcboFind()
    End Sub
    ...
    Private Sub txtFind_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtFind.TextChanged
        With DtFindBarangReturBindingSource
            Select Case cboFind.SelectedIndex
                Case 0
                    .Filter = "Kode_Retur like '%" & txtFind.Text.Trim & "%'"
                Case 1
