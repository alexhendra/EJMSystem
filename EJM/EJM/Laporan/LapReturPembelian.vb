...
Public Class LapReturPembelian
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EJM.LapReturPembelian.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLapReturPembelian
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LapReturPembelian = New LapReturPembelian()
        rpt.Site = Me.Site
        Return rpt
    End Function
