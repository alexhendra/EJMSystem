...
Public Class LapPelunasanHutang
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EJM.LapPelunasanHutang.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLapPelunasanHutang
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LapPelunasanHutang = New LapPelunasanHutang()
        rpt.Site = Me.Site
        Return rpt
    End Function
