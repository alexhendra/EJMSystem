...
Public Class LapPenjualan_Cust
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EJM.LapPenjualan_Cust.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLapPenjualan_Cust
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LapPenjualan_Cust = New LapPenjualan_Cust()
        rpt.Site = Me.Site
        Return rpt
    End Function
