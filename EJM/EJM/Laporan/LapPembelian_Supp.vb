...
Public Class LapPembelian_Supp
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EJM.LapPembelian_Supp.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLapPembelian_Supp
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LapPembelian_Supp = New LapPembelian_Supp()
        rpt.Site = Me.Site
        Return rpt
    End Function
